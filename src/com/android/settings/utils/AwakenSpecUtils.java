...
public class AwakenSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String AWAKEN_CPU_MODEL_PROPERTY = "ro.awaken.cpu";
    ...
    public static String getProcessorModel() {
        String cpuModelAwaken = SystemProperties.get(AWAKEN_CPU_MODEL_PROPERTY);
        String cpuModelFallback = SystemProperties.get(FALLBACK_CPU_MODEL_PROPERTY);
        if (!cpuModelAwaken.isEmpty()) {
            return cpuModelAwaken;
